                  ...
                  <figcaption className="pointer absolute bottom-0 flex h-full w-full flex-col justify-center bg-gradient-to-tr from-black/50 px-10 md:px-24">
                    ...
                    <div className="mt-4 md:mt-8">
                      <Link href={`${data.path}?showTrailerModal=true`}>
                        <a
                          aria-label={`Assistir Trailer for ${data.title}`}
                          className="rounded-lg bg-movieViolet px-2.5 py-1.5 font-semibold text-white shadow-2xl md:px-4 md:py-2.5 md:text-lg"
                        >
                          Assistir Trailer
                        </a>
                      </Link>
