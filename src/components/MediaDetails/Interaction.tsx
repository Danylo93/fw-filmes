          ...
          className={cn(
            {
              ...
              "bg-movieViolet ring-movieViolet": isInFavorites,
              "ring-white/70 hover:ring-movieViolet": !isInFavorites,
            },
      ...
      >
        <button
          ...
          className={cn(
            {
              "pointer-events-none cursor-not-allowed opacity-20": isLoading,
              "bg-movieViolet ring-movieViolet": isInWatchlist,
              "ring-white/70 hover:ring-movieViolet": !isInWatchlist,
            },
